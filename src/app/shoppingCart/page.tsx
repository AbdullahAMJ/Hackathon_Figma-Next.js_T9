        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mt-10">
          <div className="w-full lg:w-1/2 mb-6 lg:mb-0">
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                className="bg-[#FF9F0D] text-white px-6 py-2 rounded-r font-semibold hover:bg-[#FF9F0D] transition-colors"
              >
                Apply
              </button>
            </div>
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <button className="w-full bg-[#FF9F0D] text-white mt-4 py-3 rounded font-semibold hover:bg-[#FF9F0D] transition-colors">
                Proceed to Checkout
              </button>
            </div>
          </div>
